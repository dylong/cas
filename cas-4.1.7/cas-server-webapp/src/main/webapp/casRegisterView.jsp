...
<title>CAS Service register</title>
...
<body id="cas" class="loginbg">
	...
	<div class="content">
		...
		<h2>
			<spring:message code="screen.welcome.immotor.registered" />
		...
		<form action="" method="post" id="userForm"   >
			<table class="regConTable" border="0" cellpadding="0" cellspacing="0">
				<tbody>
					...
					<tr>
						<td>
							<input class="" id="regNickname" type="text" name="nickname" placeholder="<spring:message code="screen.welcome.input.nickname" />"/>
						</td>
					</tr>
					<tr>
						<td style="height: 60px;">
							...
							<input type="submit" value="<spring:message code="screen.welcome.input.reg.sub" />" class="regSub" id="regsub"/></td>
					</tr>
					<tr>
						<!-- 				<td style="height:50px;"></td> -->
						<td style="height: 50px;"><input class="isSer"
							type="checkbox" checked=""/> <span class="serFont">我已经阅读并同意</span>
