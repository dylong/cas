...
public final class WebUtils {
    ...
    /**
     * Put service UserInfo in request scope.
     *
     * @param context the context.
     * @param userMap the ticket value.
     */
    public static void putServiceUserInfo(
        final RequestContext context, final Map<String, Object> userMap) {
        context.getRequestScope().put("serviceUserInfo", userMap);
    }
    /**
     * 
     * @param context x.
     * @return x.
     */
    public static Map<String, Object> getUserInfo(final RequestContext context){
        return (Map<String, Object>) context.getFlowScope().get("userinfo");
    }
    /**
     * 
     ...
     */
    public static void putUserInfo(final RequestContext context, final Map<String, Object> usermap){
        context.getFlowScope().put("userinfo", usermap);
    }
}
