...
//    private RandomNickName ran = new RandomNickName();
    private final static int delta = 0x9fa5 - 0x4e00 + 1;
      
    public static char getRandomHan() {
        return (char)(0x4e00+(int)(Math.random()*(0x9fa5 - 0x4e00 + 1)));
    }
    public static StringBuffer getNicknam(int i){
...
//        RandomNickName rn = new RandomNickName();
        System.out.println(RandomNickName.getNicknam(3).toString());
